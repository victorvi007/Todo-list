  ...
  if (item.classList[0] === "del") {
    ...
    item.parentElement;
      setTimeout(() => {
         ...
         checker = item.parentElement.children[1].innerText;
        // console.log(storedData.indexOf(checker));
          
        storedData.splice(storedData.indexOf(checker),1);
        // console.log(storedData)
         localStorage.setItem("storedTodos", JSON.stringify(storedData));
